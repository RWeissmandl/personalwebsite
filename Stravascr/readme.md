The goal, in its simplest form is: connecting to Strava's API and pulling my latest activities onto my website. Here is an outline of the current process, backend all in Python:
